...
export async function createEditCabin(newCabin, id) {
  ...
  const hasImagePath = isString && newCabin.image.startsWith(supabaseUrl);

  // Generate imageName if newCabin.image is a file object
  ...
  // Only upload the image if it's a File object
  if (!isString) {
